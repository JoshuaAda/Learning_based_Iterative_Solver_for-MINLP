...
class MHE(Optimizer, Estimator):
    ...
    **Configuration and setup:**
    ...
    def _create_nlp(self)->None:
        ...
        nlp = {'x': castools.vertcat(self._opt_x), 'f': self._nlp_obj, 'g': self._nlp_cons, 'p': castools.vertcat(self._opt_p)}
        self.S = castools.nlpsol('S', solvername, nlp, self.settings.nlpsol_opts)# Create function to caculate all auxiliary expressions:
